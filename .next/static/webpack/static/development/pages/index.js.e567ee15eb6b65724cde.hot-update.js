  ...
  function Main(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "offNotiSelect", function (event) {
      if (event.target.value === 30) {
        ...
        _this.setState({
          lastOff: lastOff === "1" ? "1 hour" : "".concat(lastOff, " hours")
        });
      }
    });
...
//# sourceMappingURL=index.js.e567ee15eb6b65724cde.hot-update.js.map