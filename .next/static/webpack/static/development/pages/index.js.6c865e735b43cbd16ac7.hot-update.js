  ...
  function Main(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "offNotiSelect", function (event) {
      if (event.target.value === 30) {
        ...
        _this.setState({
          lastOff: offHolder = lastOff === "1" ? "1 hour" : "".concat(lastOff, " hours")
        });
      }
    });
...
//# sourceMappingURL=index.js.6c865e735b43cbd16ac7.hot-update.js.map