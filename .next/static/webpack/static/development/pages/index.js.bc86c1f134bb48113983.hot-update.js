  ...
  function Main(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "offNotiSelect", function (event) {
      if (event.target.value === 30) {
        ...
        _this.setState({
          lastOff: event.target.value === "1" ? "1 hour" : "".concat(lastOff, " hours")
        });
      }
    });
...
//# sourceMappingURL=index.js.bc86c1f134bb48113983.hot-update.js.map