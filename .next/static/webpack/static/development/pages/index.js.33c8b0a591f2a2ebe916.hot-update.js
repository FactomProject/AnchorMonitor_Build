  ...
  function Main(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "offNotiSelect", function (event) {
      if (event.target.value === 30) {
        ...
        _this.setState({
          lastOff: event.target.value === "1" ? "1 hour" : "".concat(event.target, " hours")
        });
      }
    });
...
//# sourceMappingURL=index.js.33c8b0a591f2a2ebe916.hot-update.js.map