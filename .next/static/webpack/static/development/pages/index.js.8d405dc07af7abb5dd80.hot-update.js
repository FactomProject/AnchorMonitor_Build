  ...
  function Main(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "offNotiSelect", function (event) {
      if (event.target.value === 30) {
        ...
        _this.setState({
          lastOff: event.target === "1" ? "1 hour" : "".concat(lastOff, " hours")
        });
      }
    });
...
//# sourceMappingURL=index.js.8d405dc07af7abb5dd80.hot-update.js.map