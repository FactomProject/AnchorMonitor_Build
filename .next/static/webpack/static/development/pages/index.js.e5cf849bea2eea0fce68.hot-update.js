  ...
  function Main(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "offNotiSelect", function (event) {
      if (event.target.value === 30) {
        ...
        _this.setState({
          lastOff: eve === "1" ? "1 hour" : "".concat(lastOff, " hours")
        });
      }
    });
...
//# sourceMappingURL=index.js.e5cf849bea2eea0fce68.hot-update.js.map